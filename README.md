...
- [netrunner-cards-data](https://github.com/nhoople/netrunner-cards-data) pinned to tag **`v0.6.0`**
...
| midnight-sun | 65 | Borealis set 1 (NRDB `ms`) — **in-progress**; sabotage/mark/charge + mark-run + core_damage IR present, most cards still have `unsupported` notes |
